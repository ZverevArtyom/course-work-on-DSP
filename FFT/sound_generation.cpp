...
const int32_t samplelenght = 128; //длина сэмпла
...
int main()
{
    ...
    generate_sin(sin1, 129, 5, 50);

    int32_t *sin2 = new int32_t[samplelenght];
    generate_sin(sin2, 129, 20, 50);

    //int32_t *sin2_ = new int32_t[samplelenght];
    //generate_sin(sin2, 4097, 200, 6536);

    //int32_t *sin3_ = new int32_t[samplelenght];
